...
class Chatter(commands.Cog):
    ...
    async def ctx_use_as_prompt(self, interaction: discord.Interaction, message: discord.Message):
        ...
        await interaction.response.send_message(f"**Demande à l'IA** · Le message de *{message.author.display_name}* a été envoyé au chatbot **{session.chatbot}**", ephemeral=True, delete_after=5)
